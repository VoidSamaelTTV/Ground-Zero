...
Shared.FemaleSeed = 'strawberryseed'
...
--- Props
Shared.WeedProps = {
    [1] = `bzzz_plants_strawberry_01`,
    [2] = `bzzz_plants_strawberry_01`,
    [3] = `bzzz_plants_strawberry_02`,
    [4] = `bzzz_plants_strawberry_02`,
    [5] = `bzzz_plants_strawberry_03`
}
...
Shared.ObjectZOffset = - 0.02 -- Z-coord offset for WeedProps
...
Shared.WaterDecay = 3.0 -- Percent of water that decays every minute
Shared.FertilizerDecay = 3.0 -- Percent of fertilizers that decays every minute

Shared.FertilizerThreshold = 40
Shared.WaterThreshold = 40
Shared.HealthBaseDecay = {10, 20} -- Min/Max Amount of health decay when the plant is below the above thresholds for water and nutrition
