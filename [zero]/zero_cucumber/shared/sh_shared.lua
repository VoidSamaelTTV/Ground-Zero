...
Shared.FemaleSeed = 'cucumberseed'
...
--- Props
Shared.WeedProps = {
    [1] = `bzzz_plants_cucumber_01`,
    [2] = `bzzz_plants_cucumber_01`,
    [3] = `bzzz_plants_cucumber_02`,
    [4] = `bzzz_plants_cucumber_02`,
    [5] = `bzzz_plants_cucumber_03`
}
