...
Shared.FemaleSeed = 'seed_weed_skywalkerog'
...
Shared.BranchItem = 'skywalkerog_crop'
...
--- Props
Shared.WeedProps = {
    [1] = `bzzz_plants_weed_red_small`,
    [2] = `bzzz_plants_weed_red_medium`,
    [3] = `bzzz_plants_weed_red_big`,
    [4] = `bzzz_plants_weed_red_bud`,
    [5] = `bzzz_plants_weed_red_bud_big`
}
...
Shared.LoopUpdate = 10 -- Time in minutes to perform a loop update for water, nutrition, health, growth, etc.
Shared.WaterDecay = 2.50 -- Percent of water that decays every minute
Shared.FertilizerDecay = 2.50 -- Percent of fertilizers that decays every minute

Shared.FertilizerThreshold = 40
Shared.WaterThreshold = 40
Shared.HealthBaseDecay = {2, 5} -- Min/Max Amount of health decay when the plant is below the above thresholds for water and nutrition
