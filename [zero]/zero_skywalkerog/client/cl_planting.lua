...
RegisterNetEvent('zero-skywalkerog:client:UseWeedSeed', function()
        ...
        if hit == 1 then
            ...
            if IsControlJustPressed(0, 38) then
                ...
                QBCore.Functions.Progressbar('spawn_plant', _U('place_sapling'), 2000, false, true, {
                    ...
                    TriggerServerEvent('zero-skywalkerog:server:CreateNewPlant', dest)
                    planted = false
                    seedUsed = false
                    ClearPedTasks(ped)
...
RegisterNetEvent('zero-skywalkerog:client:CheckPlant', function(data)
    local netId = NetworkGetNetworkIdFromEntity(data.entity)
    QBCore.Functions.TriggerCallback('zero-skywalkerog:server:GetPlantData', function(result)
        ...
        if result.health == 0 then -- Destroy plant
            exports['qb-menu']:openMenu({
                ...
                },
                {
                    ...
                    params = {
                        event = 'zero-skywalkerog:client:ClearPlant',
                        args = data.entity
                    }
                }
            })
        elseif result.growth == 100 then -- Harvest
                exports['qb-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        params = {
                            event = 'zero-skywalkerog:client:HarvestPlant',
                            args = data.entity
                        }
                    },
                })
        elseif result.gender == 'female' then -- Option to add male seed
                exports['qb-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        icon = 'fas fa-shower',
                        params = {
                            event = 'zero-skywalkerog:client:GiveWater',
                            args = data.entity
                        }
                    },
                    {
                        ...
                        params = {
                            args = data.entity,
                            event = 'zero-skywalkerog:client:GiveFertilizer',
                        }
                    }
                })
...
RegisterNetEvent('zero-skywalkerog:client:ClearPlant', function(entity)
    ...
    QBCore.Functions.Progressbar('clear_plant', _U('clear_plant'), 8500, false, true, {
        ...
        TriggerServerEvent('zero-skywalkerog:server:ClearPlant', netId)
        ClearPedTasks(ped)
        RemoveAnimDict('amb@medic@standing@kneel@base')
        RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
    end, function()
...
RegisterNetEvent('zero-skywalkerog:client:HarvestPlant', function(entity)
    local netId = NetworkGetNetworkIdFromEntity(entity)
    local ped = PlayerPedId()
    TaskTurnPedToFaceEntity(ped, entity, 1.0)
    Wait(1500)
    ...
    QBCore.Functions.Progressbar('harvest_plant', _U('harvesting_plant'), 8500, false, true, {
        ...
        TriggerServerEvent('zero-skywalkerog:server:HarvestPlant', netId)
        ClearPedTasks(ped)
        RemoveAnimDict('amb@medic@standing@kneel@base')
        RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
    end, function()
...
RegisterNetEvent('zero-skywalkerog:client:PoliceDestroy', function(entity)
    local netId = NetworkGetNetworkIdFromEntity(entity)
    local ped = PlayerPedId()
    TaskTurnPedToFaceEntity(ped, entity, 1.0)
    Wait(500)
    ClearPedTasks(ped)
    TriggerServerEvent('zero-skywalkerog:server:PoliceDestroy', netId)
end)

RegisterNetEvent('zero-skywalkerog:client:FireGoBrrrrrrr', function(coords)
    local ped = PlayerPedId()
...
RegisterNetEvent('zero-skywalkerog:client:GiveWater', function(entity)
    if QBCore.Functions.HasItem(Shared.FullCanItem, 1) then
        ...
        QBCore.Functions.Progressbar('weedplanting_water', _U('watering_plant'), 6000, false, false, {
            ...
            TriggerServerEvent('zero-skywalkerog:server:GiveWater', netId)
            ClearPedTasks(ped)
...
RegisterNetEvent('zero-skywalkerog:client:OpenFillWaterMenu', function()
    exports['qb-menu']:openMenu({
        {
        ...
        },
        {
            ...
            params = {
                event = 'zero-skywalkerog:client:FillWater',
            }
        }
    })
end)

-- RegisterNetEvent('zero-skywalkerog:client:FillWater', function()
...
--         disableCombat = true,
--     }, {}, {}, {}, function()
--         TriggerServerEvent('zero-skywalkerog:server:GetFullWateringCan')
--     end, function() -- Cancel
--         QBCore.Functions.Notify(_U('canceled'), 'error', 2500)
--     end)
-- end)

RegisterNetEvent('zero-skywalkerog:client:GiveFertilizer', function(entity)
    if QBCore.Functions.HasItem(Shared.FertilizerItem, 1) then
        ...
        QBCore.Functions.Progressbar('weedplanting_fertilizer', _U('fertilizing_plant'), 6000, false, false, {
            ...
            TriggerServerEvent('zero-skywalkerog:server:GiveFertilizer', netId)
            ClearPedTasks(ped)
            DeleteEntity(created_object)
        end, function()
            ClearPedTasks(ped)
...
-- RegisterNetEvent('zero-skywalkerog:client:AddMaleSeed', function(entity)
...
--             disableCombat = true,
--         }, {}, {}, {}, function()
--             TriggerServerEvent('zero-skywalkerog:server:AddMaleSeed', netId)
--             ClearPedTasks(ped)
--             RemoveAnimDict('amb@medic@standing@kneel@base')
--             RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
--         end, function()
...
CreateThread(function()
    exports['qb-target']:AddTargetModel(Shared.WeedProps, {
        options = {
            {
                type = 'client',
                event = 'zero-skywalkerog:client:CheckPlant',
