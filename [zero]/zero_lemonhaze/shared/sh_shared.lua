...
Shared.FemaleSeed = 'seed_weed_whitewidow'
...
Shared.BranchItem = 'whitewidow_crop'
...
Shared.LoopUpdate = 12 -- Time in minutes to perform a loop update for water, nutrition, health, growth, etc.
