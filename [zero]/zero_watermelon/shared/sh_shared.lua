...
Shared.FemaleSeed = 'watermelonseed'
...
--- Props
Shared.WeedProps = {
    [1] = `bzzz_plants_melon_01`,
    [2] = `bzzz_plants_melon_01`,
    [3] = `bzzz_plants_melon_02`,
    [4] = `bzzz_plants_melon_02`,
    [5] = `bzzz_plants_melon_03`
}
