...
Shared.FemaleSeed = 'seed_weed_bluedream'
...
Shared.BranchItem = 'bluedream_crop'
-- Shared.WeedItem = 'weedplant_weed'
-- Shared.PackedWeedItem = 'weedplant_packedweed'
-- Shared.SusPackageItem = 'weedplant_package'
Shared.LabkeyItem = 'security_card_01' -- Key required to enter the weed lab
Shared.WeaponsKeyItem = 'security_card_02' -- Key required to enter the weed lab
Shared.GunrunningKeyItem = 'security_card_02' -- Key required to enter the weed lab
Shared.RecycleKeyItem = 'security_card_02' -- Key required to enter the weed lab
...
Shared.WeedLab = {
    ...
    -- EnableSound = false, --  Set this to false if you dont want the interact sound while exiting / entering the wee lab.
}
...
--- Props
Shared.WeedProps = {
    [1] = `bzzz_plants_weed_blue_small`,
    [2] = `bzzz_plants_weed_blue_medium`,
    [3] = `bzzz_plants_weed_blue_big`,
    [4] = `bzzz_plants_weed_blue_bud`,
    [5] = `bzzz_plants_weed_blue_bud_big`
}
