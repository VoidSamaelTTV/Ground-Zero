...
Shared.FemaleSeed = 'seed_weed_skunk'
...
--- Props
Shared.WeedProps = {
    [1] = `bzzz_plants_weed_green_small`,
    [2] = `bzzz_plants_weed_green_medium`,
    [3] = `bzzz_plants_weed_green_big`,
    [4] = `bzzz_plants_weed_green_bud`,
    [5] = `bzzz_plants_weed_green_bud_big`
}
