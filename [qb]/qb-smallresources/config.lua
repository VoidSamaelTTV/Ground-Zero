...
Config.PauseMapText = '~y~Ground Zero'                                     -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
...
Config.Discord = {
    ...
    applicationId = '1171629547804971092',                   -- The discord application id
    iconLarge = 'ground_zero',                               -- The name of the large icon
    iconLargeHoverText = 'Ground Zero', -- The hover text of the large icon
    ...
    buttons = {
        {
            text = 'Play',
            url = 'cfx.re/join/rk3x7p'
        },
        {
            text = 'Discord',
            url = 'https://discord.gg/UcKyExV829'
        }
    }
}
...
Config.Disable = {
    hudComponents = { 1, 2, 4, 7, 9, 14, 19, 20, 21 }, -- Hud Components: https://docs.fivem.net/natives/?_0x6806C51AD12B83B8
    controls = { 37,26 },                                            -- Controls: https://docs.fivem.net/docs/game-references/controls/
...
Config.Consumables = {
    canned_beans = { -- default food items
    ['canned_beans'] = math.random(30, 30),
    },
    canned_soup = { -- default food items
    ['canned_soup'] = math.random(30, 30),
    },
    canned_meat = { -- default food items
    ['canned_meat'] = math.random(40, 40),
    },
    canned_olives = { -- default food items
    ['canned_olives'] = math.random(10, 10),
    },
    canned_peas = { -- default food items
    ['canned_peas'] = math.random(20, 20),
    },
    sandwiches = { -- default food items
        ['eggsandwich'] = math.random(20, 20),
        ['tunasandwich'] = math.random(20, 20),
        ['hamsandwich'] = math.random(20, 20),
    },
    cucumber = { -- default food items
        ['cucumber'] = math.random(15, 15),
    },
    eggplant = { -- default food items
        ['eggplant'] = math.random(20, 20),
    },
    onion = { -- default food items
        ['onion'] = math.random(10, 10),
    },
    potato = { -- default food items
        ['potato'] = math.random(15, 15),
    },
    strawberry = { -- default food items
        ['strawberry'] = math.random(5, 5),
    },
    tomato = { -- default food items
        ['tomato'] = math.random(10, 10),
    },
    watermelon = { -- default food items
        ['watermelon'] = math.random(20, 20),
    },
    meteorite = { -- default food items
        ['meteorite'] = math.random(10, 10),
    },
    egochaser = { -- default food items
        ['egochaser'] = math.random(10, 10),
    },
    psnqs = { -- default food items
        ['psnqs'] = math.random(5, 5),
    },
    water = { -- default drink items
        ['water'] = math.random(30, 30),
    },
    ecola = { -- default drink items
        ['ecola'] = math.random(20, 20),
    },
    sprunk = { -- default drink items
        ['sprunk'] = math.random(20, 20),
    },
    orangotang = { -- default drink items
        ['orangotang'] = math.random(20, 20),
    },
    coffee = { -- default drink items
        ['coffee'] = math.random(15, 15),
    },
    tea = { -- default drink items
        ['tea'] = math.random(15, 15),
    },
