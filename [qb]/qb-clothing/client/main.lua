...
local function SaveSkin()
    ...
    TriggerEvent("qb-inventory:c:refreshClothes")

    TriggerEvent("qb-inventory:c:giveClothesAsItem", skinData, previousSkinData, false)
end
...
RegisterNetEvent('qb-clothing:client:openSurgeon', function()
    customCamLocation = nil
    openMenu({
        {menu = "character", label = Lang:t("menu.features"), selected = true},
        {menu = "hair", label = Lang:t("menu.hair"), selected = false},
