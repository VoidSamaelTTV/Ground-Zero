...
Config.MinimalDoctors = 1000                                    -- How many players with the ambulance job to prevent the hospital check-in system from being used
...
Config.AlwaysBleedChance = 60                                -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
...
Config.BleedMovementTick = 5                                -- How many seconds is taken away from the bleed tick rate if the player is walking, jogging, or sprinting
Config.BleedMovementAdvance = 2                              -- How much time moving while bleeding adds
Config.BleedTickDamage = 5                                   -- The base damage that is multiplied by bleed level everytime a bleed tick occurs
...
Config.MajorArmoredBleedChance = 40 -- The chance, in percent, that a player will get a bleed effect when taking heavy damage while wearing armor
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        vector3(775.64, 1275.47, 361.34),
    },
    ['duty'] = {
        vector3(737.23, 1286.00, 360.3),
    },
    ['vehicle'] = {
        vector4(790.25, 1276.61, 360.3, 260.66),
    },
    ['helicopter'] = {
        vector4(694.92, 1283.04, 361.67, 170.91),
    },
    ['roof'] = {
    ...
    ['stash'] = {
        vector3(765.38, 1297.0, 361.43),
    },
    ['beds'] = {
        { coords = vector4(774.29, 1283.84, 361.99, 262.5),    taken = false, model = 1631638868 },
        { coords = vector4(774.31, 1281.53, 361.99, 262.51),  taken = false, model = 1631638868 },
        { coords = vector4(774.19, 1279.05, 361.99, 264.66),   taken = false, model = 2117668672 },
        { coords = vector4(779.23, 1281.52, 361.99, 92.61),    taken = false, model = 2117668672 },
        { coords = vector4(779.22, 1283.91, 361.99, 86.93),   taken = false, model = 2117668672 },
        --- paleto
    ...
    ['hospital'] = {
        {
            ...
            ['location'] = vector3(775.64, 1275.47, 361.34),
            ['beds'] = {
                { coords = vector4(774.29, 1283.84, 361.99, 262.5),    taken = false, model = 1631638868 },
                { coords = vector4(774.31, 1281.53, 361.99, 262.51),  taken = false, model = 1631638868 },
                { coords = vector4(774.19, 1279.05, 361.99, 264.66),   taken = false, model = 2117668672 },
    ...
    ['stations'] = {
        { label = Lang:t('info.pb_hospital'), coords = vector3(775.74, 1275.64, 361.34) }
    }
}
