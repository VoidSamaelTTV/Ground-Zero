...
QBShared.StarterItems = {
    ...
    ['weapon_knife'] = { amount = 1, item = 'weapon_knife'},
    ['bandage'] = { amount = 4, item = 'bandage'},
    -- ['compass'] = { amount = 1, item = 'compass'},
    ['charcoal_tracksuit_top'] = { amount = 1, item = 'charcoal_tracksuit_top'},
    ['charcoal_tracksuit_pants'] = { amount = 1, item = 'charcoal_tracksuit_pants'},
    ['calypso_runners'] = { amount = 1, item = 'calypso_runners'},
    ['cash'] = { amount = 5000, item = 'cash'},
