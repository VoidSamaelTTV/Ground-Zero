const Targeting = Vue.createApp({
    data() {
        return {
            ...
            ChangeTextIconColor: true, // This is if you want to change the color of the icon next to the option text with the text color
            StandardEyeIcon: "", // This is the default eye icon
            CurrentIcon: this.StandardEyeIcon, // leave this
            SuccessColor: "#d2f20d", // This is the color when the target has found the option
    ...
    methods: {
        ...
        FoundTarget(item) {
            ...
            this.HexgonStyleObject.textShadow = "#b3e619 0px 0 20px";
            this.HexgonStyleObject.webkitTextStroke = "1.5px #d9fa4e";
        },
            ...
            for (let [index, itemData] of Object.entries(item.data)) {
                if (itemData !== null) {
                    ...
                    if (this.ChangeTextIconColor) {
                        this.targetLabel.innerHTML +=
                        `<div id="target-option-${index}" style=" color: ${this.StandardColor}; background-color: #575A42; border-radius: 8px ;padding: 5px 5px; margin-bottom: 5px;">
