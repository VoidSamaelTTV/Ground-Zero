Config = {
  BankAccountName = "cash",   -- ESX account name for bank.
  ...
  Drones = {
    [1] = {
      label = "Recon Drone",                               -- Visible text.
      name = "recon_drone",                                -- Item name.
    ...
    [2] = {
      label = "Advanced Drone",                               -- Visible text.
      name = "advanced_drone",                                -- Item name.
      public = true,                                         -- Can be used by anybody?
      price = 10000,                                          -- Price
      model = GetHashKey('ch_prop_casino_drone_02a'),        -- Model
      stats = {                        
    ...
    [3] = {
      label = "Bomber Drone",                               -- Visible text.
      name = "bomber_drone",                                -- Item name.
      public = true,                                         -- Can be used by anybody?
      price = 10000,                                          -- Price
      model = GetHashKey('ch_prop_casino_drone_02a'),        -- Model
      stats = {                        
    ...
    [4] = {
      label = "Tactical Drone",                               -- Visible text.
      name = "tactical_drone",                                -- Item name.
      public = true,                                         -- Can be used by anybody?
      price = 10000,                                          -- Price
      model = GetHashKey('ch_prop_casino_drone_02a'),        -- Model
      stats = {                        
