...
Config.UseBlipToAccessMarket = false
...
Config.BlipCoords = { 
	{x = -437.35, y = 1098.24, z = 327.68, radius = 2, blipId = 78, blipColor = 3, blipScale = 0.9, blipText = "Marketplace", showMarkerRadius = 50, MarkerID = 29},
}
...
Config.BlackmarketAllowedJobs = {
	-- {
	-- 	job = "unemployed", -- Job that can access the blackmarket
